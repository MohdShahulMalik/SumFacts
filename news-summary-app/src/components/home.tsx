    ...
    return (
        <main className = {styles["home-body"]}>
            <div className = {styles["app-description"]}>
                ...
                <h3 className = {styles["extended-despricption"]}>With SumFacts, get concise summaries of the latest news articles from trusted sources. Keep up-to-date with the most important information while saving time. Ensure credibility with our advanced fact-checking features.</h3>
            </div>
